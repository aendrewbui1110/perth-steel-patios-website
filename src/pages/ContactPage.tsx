...
export default function ContactPage() {
  return (
    <>
      ...
      <section className="pt-32 pb-16 bg-[#131311] border-b border-[#1A1917]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-xs text-[#5E5E58] mb-6">
            ...
            <span className="text-[#858580]">Contact</span>
          </div>
      ...
      <section className="py-20 bg-[#0C0C0F]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            >
              <div className="bg-[#1A1917] border border-[#28271F] rounded-xl p-8 sticky top-28">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-11 h-11 bg-[#C8713A]/10 border border-[#C8713A]/20 rounded flex items-center justify-center flex-shrink-0">
                      <Phone size={20} className="text-[#C8713A]" />
                    </div>
                    <div>
                      <p className="text-[10px] font-bold text-[#5E5E58] uppercase tracking-widest mb-1">
                        Phone
                      </p>
                      <a
                        href="tel:1300000000"
                        className="text-[#EAE6DF] hover:text-[#C8713A] transition-colors text-lg font-medium"
                      >
                        1300 000 000
                      </a>
                    </div>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-11 h-11 bg-[#C8713A]/10 border border-[#C8713A]/20 rounded flex items-center justify-center flex-shrink-0">
                      <Mail size={20} className="text-[#C8713A]" />
                    </div>
                    <div>
                      <p className="text-[10px] font-bold text-[#5E5E58] uppercase tracking-widest mb-1">
                        Email
                      ...
                      <a
                        ...
                        className="text-[#858580] hover:text-[#C8713A] transition-colors font-medium break-all"
                      >
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-11 h-11 bg-[#C8713A]/10 border border-[#C8713A]/20 rounded flex items-center justify-center flex-shrink-0">
                      <Clock size={20} className="text-[#C8713A]" />
                    </div>
                    <div>
                      <p className="text-[10px] font-bold text-[#5E5E58] uppercase tracking-widest mb-1">
                        Hours
                      </p>
                      <p className="text-[#858580] font-medium">Mon-Fri: 7am - 5pm</p>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-11 h-11 bg-[#C8713A]/10 border border-[#C8713A]/20 rounded flex items-center justify-center flex-shrink-0">
                      <MessageCircle size={20} className="text-[#C8713A]" />
                    </div>
                    <div>
                      <p className="text-[10px] font-bold text-[#5E5E58] uppercase tracking-widest mb-1">
                        Response Time
      ...
      <section className="py-16 bg-[#131311] border-t border-[#1A1917]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            <div className="flex flex-wrap justify-center gap-2.5">
              {suburbs.map((suburb) => (
                <Link
                  ...
                  className="text-xs font-semibold uppercase tracking-wider text-[#858580] bg-[#1A1917] border border-[#28271F] px-4 py-2 rounded hover:border-[#C8713A]/40 hover:text-[#EAE6DF] transition-colors duration-200"
                >
                  {suburb.name}
                </Link>
              ))}
      ...
      {/* Trust Signals Bar */}
      <section className="py-12 bg-[#0C0C0F] border-y border-[#1A1917]">
            ...
            {trustSignals.map((signal) => {
              ...
              return (
                <div key={signal.label} className="flex flex-col items-center gap-2">
                  ...
                  <p className="text-[#5E5E58] text-xs uppercase tracking-widest">{signal.sublabel}</p>
                </div>
              );
            })}
          </div>
