    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-[#111115] border-b border-[#1A1A20]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-xs text-[#5E5E68] mb-6">
            ...
            <span className="text-[#858590]">Process</span>
          </div>
      ...
      {steps.map((step, index) => {
        ...
        return (
          <section
            key={step.number}
            className={`py-20 ${index % 2 === 0 ? 'bg-[#0D0D11]' : 'bg-[#111115]'}`}
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className={`flex flex-col lg:flex-row items-center gap-12 lg:gap-20 ${!isEven ? 'lg:flex-row-reverse' : ''}`}>
                ...
                >
                  <div className="flex items-center gap-4 mb-6">
                    <span className="text-6xl md:text-7xl font-bold text-[#D4622A]/15 select-none leading-none">
                      {step.number}
                    </span>
                    <div className="w-14 h-14 bg-[#D4622A]/10 border border-[#D4622A]/25 rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="space-y-6">
                    <div>
                      <h4 className="text-[10px] font-bold text-[#D4622A] uppercase tracking-[0.2em] mb-2">
                        What Happens
                      </h4>
                      <p className="text-[#858590] leading-relaxed">{step.whatHappens}</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-[#858590] leading-relaxed">{step.whatYouNeed}</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-[#858590] leading-relaxed">{step.timeline}</p>
                    </div>

                    {step.specialNote && (
                      <div className="bg-[#D4622A]/5 border border-[#D4622A]/15 rounded-lg p-5 mt-4">
      ...
      <section className="py-20 bg-[#141418]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              <div className="w-14 h-14 bg-[#D4622A]/10 border border-[#D4622A]/25 rounded-full flex items-center justify-center flex-shrink-0">
                <FileCheck size={24} className="text-[#D4622A]" />
              </div>
            ...
            <p className="text-[#858590] leading-relaxed mb-8 text-lg">
            ...
            <div className="bg-[#1A1A20] border border-[#28282F] rounded-xl p-8 mb-8">
              <h3 className="text-xs font-bold text-[#D4622A] uppercase tracking-[0.2em] mb-5">
                What's Involved
              </h3>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#D4622A] mt-2 flex-shrink-0" />
                    <span className="text-[#858590] leading-relaxed">{item}</span>
                  </li>
                ))}
              </ul>
            </div>

            <div className="bg-[#D4622A]/5 border border-[#D4622A]/15 rounded-lg p-6">
