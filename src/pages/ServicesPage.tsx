...
export default function ServicesPage() {
  return (
    <>
      ...
      <section className="pt-32 pb-16 bg-[#131311] border-b border-[#1A1917]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center gap-2 text-xs text-[#5E5E58] mb-8">
            ...
            <span className="text-[#858580]">Services</span>
          </nav>
            ...
            {services.map((service, index) => (
              ...
              >
                <Link
                  ...
                  className="group relative block bg-[#1C1A18] border border-[#22211E] rounded-xl p-8 hover:border-[#C8713A]/50 hover:-translate-y-1 transition-all duration-300 overflow-hidden h-full"
                >
                  {/* Large faded number */}
                  <span className="absolute top-4 right-5 font-heading text-8xl font-bold text-[#C8713A]/5 group-hover:text-[#C8713A]/10 transition-colors leading-none select-none">
                    {service.number}
                  </span>
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    ...
                    <p className="text-[#858580] text-sm leading-relaxed mb-6 flex-grow">
                      {service.description}
                    </p>
                    <div className="flex items-center gap-2 text-[#C8713A] text-sm font-bold uppercase tracking-widest group-hover:gap-3 transition-all duration-200">
                      Learn More
      ...
      {/* CTA Section */}
      <section className="py-20 bg-[#131311]">
