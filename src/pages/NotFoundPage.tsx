...
export default function NotFoundPage() {
  return (
    <section className="pt-32 pb-24 bg-[#0C0C0F] min-h-[70vh] flex items-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <span className="font-heading text-[120px] md:text-[180px] font-bold text-[#C8713A]/15 leading-none select-none block">
          404
        </span>
        <h1 className="text-3xl md:text-4xl font-bold text-[#EAE6DF] uppercase tracking-tight mb-4 -mt-8">
          Page Not Found
        </h1>
        <p className="text-[#858580] mb-10 max-w-md mx-auto leading-relaxed">
